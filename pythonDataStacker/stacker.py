                ...
                for j2 in range (2):
                    for k in range(1, 20):
                        ...
                        if k <= 10:
                            ...
                            kstr = str(k-1)
                        dataStack =  Stacker.makestack(self.inpath_exp143 + 'r' + rowstr + 'c' + colstr + 'f01p01-ch', 'sk' + str(k) + 'fk1fl1.tiff', 6 )
                        Stacker.saveim(self.outpath_exp143 + 'r' + str(i) + 'c' + str(j+j2) + 'f01p01', 'sk' + kstr, dataStack)
